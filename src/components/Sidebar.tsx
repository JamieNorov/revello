...
export default function Sidebar({ collapsed, onToggle }: { collapsed: boolean; onToggle: () => void }) {
  ...
  return (
    <aside className={`revello-sidebar${collapsed ? ' collapsed' : ''}`}>
      <div className="sidebar-brand">
        <div className="brand-mark"><span/><span/><span/></div>
        {!collapsed && <div className="brand-text"><strong>Revello</strong></div>}
      </div>
      ...
      <div className="sidebar-footer">
        ...
        {!collapsed && (
          <div className="user-row">
            <span className="user-avatar">JN</span>
            <div><strong>Jamie Norov</strong><small>sceneryimage@gmail.com</small></div>
          </div>
        )}
      </div>
    </aside>
